...
sumatoria:
	...
	add	AL, [BX] ; Sumo a AL el valor que esta almacenado en la direccion de memoria que guarda BX
	add	BX, 1h ; Le sumo 1 a el valor dentro de BX para asi ir avanzando posiciones de memoria
	loop	sumatoria ; Hago un loop hasta que CX se haga 0, esto pasa debido a que le resto 1 por cada iteracion hecha
		; Solo se hara 8 veces, debido a que es la cantidad de numero en mi carnet


	mov	CL, 8d ;Poner en este valor el numero de la cantidad de datos que ocuparemos de divisor
